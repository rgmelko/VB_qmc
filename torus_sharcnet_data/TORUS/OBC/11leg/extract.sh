...
awk '(NR==20){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 19/avgent ; var1=$(awk '($1==20){print -log($2)+v1}' v1=$var1 19/avgent ) ; err1=$(awk '($1==20){print $3*$3 + e1}' e1=$err1 19/avgent ) ;
awk '(NR==21){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 20/avgent ; var1=$(awk '($1==21){print -log($2)+v1}' v1=$var1 20/avgent ) ; err1=$(awk '($1==21){print $3*$3 + e1}' e1=$err1 20/avgent ) ;
awk '(NR>21 ){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 21/avgent ;
