...
mkdir 16; cp torus* 16/torus16;  awk '{ if(NR!=6) print $0; if(NR==6) print "16"}' param.txt > 16/param.txt; cd 16; sqsub -o 0.log -r 7d ./torus*; cd ..; 
mkdir 17; cp torus* 17/torus17;  awk '{ if(NR!=6) print $0; if(NR==6) print "17"}' param.txt > 17/param.txt; cd 17; sqsub -o 0.log -r 7d ./torus*; cd ..; 
mkdir 18; cp torus* 18/torus18;  awk '{ if(NR!=6) print $0; if(NR==6) print "18"}' param.txt > 18/param.txt; cd 18; sqsub -o 0.log -r 7d ./torus*; cd ..; 
mkdir 19; cp torus* 19/torus19;  awk '{ if(NR!=6) print $0; if(NR==6) print "19"}' param.txt > 19/param.txt; cd 19; sqsub -o 0.log -r 7d ./torus*; cd ..; 
mkdir 20; cp torus* 20/torus20;  awk '{ if(NR!=6) print $0; if(NR==6) print "20"}' param.txt > 20/param.txt; cd 20; sqsub -o 0.log -r 7d ./torus*; cd ..; 
mkdir 21; cp torus* 21/torus21;  awk '{ if(NR!=6) print $0; if(NR==6) print "21"}' param.txt > 21/param.txt; cd 21; sqsub -o 0.log -r 7d ./torus*; cd ..; 
