...
awk '(NR==14){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 13/avgent ; var1=$(awk '($1==13){print -log($2)+v1}' v1=$var1 13/avgent ) ; err1=$(awk '($1==13){print $3*$3 + e1}' e1=$err1 13/avgent ) ;
awk '(NR==15){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 14/avgent ; var1=$(awk '($1==13){print -log($2)+v1}' v1=$var1 14/avgent ) ; err1=$(awk '($1==13){print $3*$3 + e1}' e1=$err1 14/avgent ) ;
awk '(NR>15 ){print $1, -log($2)+v1, sqrt($3*$3/($2*$2) + e1)}' v1=$var1 e1=$err1 15/avgent ;
