...
\begin{figure} {
\includegraphics[width=2.9in]{L8n12_ratio.eps} \caption{(color online) 
\label{L16fig}
...
We therefore expect that the algorithm will require only a polynomial number of samples for converge of the Renyi entropy on arbitrary system sizes.
