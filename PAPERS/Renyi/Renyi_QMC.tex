...
\label{swap_2}
An 8-site chain, with two non-interacting copies (top and bottom) before (a) and after (b) operator of the $Swap_A$ operator.  
The region A consists of three light-colored spins on the left; the entangled region B.
}
} \end{figure}
