...
\end{eqnarray}
Eqs.~(\ref{eq:tm1},\ref{eq:tm2},\ref{eq:tm3}) conserve the number of fermions, and encode the dimer fully-packed and hard-core constraints on the square lattice. To account for periodic boundary conditions  we also have to impose $c_{L_x}^\dag=(-1)^{N+1}c_0^\dag$. Rewriting this in matrix form using Einstein's summation convention
\begin{equation}
