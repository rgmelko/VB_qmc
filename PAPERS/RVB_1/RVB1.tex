...
and fluctuations, are now benefitting from an infusion of ideas related to quantum information and entanglement. The importance of this new resource is most strikingly 
...
This, however, is a formidable task: not only is $c$ a subleading contribution to the ground state energy, but finding it also requires the knowledge of the velocity.
%
...
state with topological order.
%, that is, a universal quantity reflecting the emergent gauge symmetry.
...
Subleading logarithms \textcolor{red}{from corner contributions} are also predicted to occur at critical points, the coefficients of which are universal \cite{logcorner,Max}.
...
charge for non-conformally invariant systems in two dimensions (2D). % that may contain
...
we observe the emergence of a shape-dependent scaling function that closely mimics the chord-length contribution of 1D CFT on finite-size systems, similar to the case of $\pi$-flux fermions.
