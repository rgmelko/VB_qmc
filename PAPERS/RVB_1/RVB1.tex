...
{\it Discussion---} Using three model systems, we have demonstrated that scaling of the Renyi entanglement entropy in gapless wavefunctions contains a hereunto unpredicted scaling term that depends on the shape of the subregion A.  This scaling term is subleading to the area law, and depends on the dimensionless aspect ratios of the subregion and the lattice dimensions.

Quantum Monte Carlo (QMC) simulations of the Heisenberg N\'eel groundstate, and the short-range RVB wavefunction 
