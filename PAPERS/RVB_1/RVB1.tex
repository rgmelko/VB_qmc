...
\textcolor{red}{The presence of an additive logarithmic divergence in the Dirac fermion for different lattice aspect ratios hints however that the precise form of this function may differ from a chord-length in the 2D thermodynamic limit.}
\end{abstract}
\maketitle
...
This, however, is a formidable task: not only is $c$ a subleading contribution to the ground state energy, but it also requires the knowledge of the \textcolor{red}{\sout{Fermi}} velocity.
%
...
The most well established of these is the {\it topological entanglement entropy} \cite{Alioscia1,Alioscia2,KP,LW} of a \textcolor{red}{(topologically ordered state?)} gapped
