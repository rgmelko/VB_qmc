...
A necessary first step is to study the scaling of entanglement entropy in
the ground states of simple 2D gapless systems. Gapless
...
(\ref{1Dcft}) is manifestly size-dependent. 
In this paper, we explore the presence of similar behavior in 2D 
by examining the finite-size scaling of the second Renyi entropy in the N\'eel state, 
and the nearest-neighbor resonating-valence-bond (RVB) wavefunction
