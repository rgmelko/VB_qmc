...
within statistical noise is exponentially hard. Hence the advantage of importance sampling (time speed-up 
from exponential to polynomial scaling) is lost. This predicament is the QMC sign problem.

We here consider classes of quantum Hamiltonians for which it is possible to choose a basis in which all 
the $W_C\geq 0$. These ``sign-problem free'' Hamiltonians can generally be simulated in polynomial time by 
