...
\begin{figure}
\centerline{\psfig{figure=jq3histo.eps,height=5cm}}
...
results for the correlation functions on large lattices. It will also be very interesting to use the methods discussed in Sec.~X to quantify the
entanglement in the SU($2$) and SU($N$) models.
