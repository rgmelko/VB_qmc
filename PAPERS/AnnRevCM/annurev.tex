...
Hamiltonians amenable to QMC simulations. Numerical work preceding the theory \cite{Sandvik02} had already indicated the intriguing possibility of 
...
is a constant. The rate of decay of the oscillating term toward the non-zero value $D^2$ as $r\to \infty$ defines the correlation length $\xi$ (where we suppressed 
