...
in the bilayer. This bilayer model just described is illustrated in Fig.~\ref{fig:pd_bil}(a). The $J_\perp$ only model has a featureless non-degenerate ground state
consisting of a product of vertical valence bonds, {\em i.e.}, a valence-bond liquid (VBL). The introduction of intra-layer couplings like the $J_1$-$J_2$ interactions will
...
state as long as they are small compared to $J_\perp$ (see Fig.~\ref{fig:pd_bil}(b)). In the opposite limit when $J_\perp$ is weak, we can ask an interesting question 
