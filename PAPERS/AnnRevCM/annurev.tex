...
Fermion QMC methods have also been developed where the signs are completely removed, but after initial optimism 
...
Large-scale QMC studies of some sign-problem free fermionic models with interesting ground states phases and quantum critial points are possible.
...
has also been studied with determinant QMC simulations \cite{Sorella92,Paiva05}. Interestingly, a recent study found evidence for a gapped spin liquid between 
the semi-metal and the N\'eel state  \cite{Meng10}, and this spurred intense activities to deduce the exact nature of this
state \cite{clark2011:honey,lu2011:honey,wang2010:honey,Ran11}. However, a subsequent QMC study on larger lattices \cite{Sorella12} has cast doubt 
on the extrapolations on which the existence of the spin liquid relied.

Very recently, a sign-problem free quantum action was identified in which a bosonic order parmater condenses in the background of a Fermi surface 
\cite{berg2012:mqcp}. This opens up the exciting possibility of unbiased studies of magnetic critical points in a metal, a topic of long-standing interest 
in condensed matter physics \cite{vojta2007:rmp}.
