...
states are beyond reach in practice because their physical properties are fundamentally tied to the difficulties in circumventing the sign problem. For instance the``Bose metal'' spin-liquid phase with a Fermi sea of emergent fermions appears to have a complex sign structure that  would be difficult to reproduce in a sign-free Hamiltonian~\cite{motrunich2007:dbl}. On the other hand, as we have reviewed in Sec.~\ref{sec:bfgz2} $Z_2$ spin-liquid ground states have been found in models with U(1) symmetry. An interesting open challenge is to find  the $Z_2$ spin liquid [which itself is a broad class if states \cite{Wen03}] in sign-free SU($2$) invariant models. 
