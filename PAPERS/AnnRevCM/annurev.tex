...
corresponds to fully open boundaries, while other choises of the trial state leads to open boundaries with some weighting of the bra and ket 
states. 
...
mention experimental realization and simulations of 3D dimer networks

\subsection{Deconfined N\'eel--VBS transition in J-Q models}

N\'eel to VBS transitions in J-Q model; deconfined quantum-criticality, anomalous scaling of VBS order
