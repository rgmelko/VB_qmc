...
Understanding the ground states of interacting microscopic quantum Hamiltonians is one of the central defining challenges of quantum condensed matter physics.
Quantum field theory is a powerful and general framework for studies of low-energy properties of complex, strongly 
correlated and entangled quantum matter \cite{Sachdev11}. However, the continuum approach has potential pitfalls due to its generality and significant limitations since it cannot capture many features of lattice scale physics. It is, therefore, important to study microscopic lattice Hamiltonians directly. One of the most fruitful directions is to combine the advantages of both methods by analyzing data from unbiased numerical investigations of lattice Hamiltonians with quantum field theoretic predictions of emergent low energy properties. 
