...
fluctuate and there are no broken symmetries, while in the valence-bond-solid there are residual interactions between the singlets, leading to crystalline
order.}
\label{rfig}
\end{figure}
...
While some interesting applications of these methods have appeared~\cite{chandra2012:thirring}, it remains to be seen whether these exciting developments
can be applied to a wider range of fermionic and frustrated designer Hamiltonians.
...
Recently, two Monte Carlo studies of sign problem free fermionic models with interesting ground states phases and quantum critial points have appeared. A spin
liquid state in the honeycomb-lattice Hubbard model between the semi-metal at weak coupling and the N\'eel state at strong coupling has been detected \cite{Meng10}, but an
accepted theory for this spin liquid is currently unavailable \cite{clark2011:honey,lu2011:honey,wang2010:honey}. Most recently \cite{berg2012:mqcp}, a sign problem free
quantum action has been identified in which a bosonic order parmater condenses in the background of a Fermi surface. This opens up the exciting possibility of unbiased
studies of magnetic critical points in a metal, a topic of long-standing interest in condensed matter physics \cite{vojta2007:rmp}.
