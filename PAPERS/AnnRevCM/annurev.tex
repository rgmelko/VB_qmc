...
for which there is no sign problem, or it is known how to circumvent it, still contains a vast range of Hamiltonians with non-trivial and interesting 
...
\begin{figure}
\centerline{\psfig{figure=pd_su6_bil.eps,height=9cm,angle=90}}
...
examples of the indispensable role of QMC studies of designer Hamiltonians \cite{Gurarie09}. Another example is the extended hardcore Bose-Hubbard model with 
