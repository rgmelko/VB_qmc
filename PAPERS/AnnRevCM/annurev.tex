...
ordered state for all $N\geq 3$~\cite{barber1989:d1n3_vbs,klumper1989:d1n3_vbs}.   In two-dimensions, $H_{J_1}$ was shown to map onto a dimer model
with only a kinetic term
in the large-$N$ limit~\cite{read1989:nucphysB}. From direct numerical simulations
...
determined~\cite{harada2003:sun} to lie between $N=4$ and $N=5$ by quantum Monte Carlo
