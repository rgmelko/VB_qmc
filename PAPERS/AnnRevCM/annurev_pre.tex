...
While some interesting applications of these methods have appeared~\cite{chandra2012:thirring}, It remains to be seen whether these exciting developments can be applied to a wider range of fermionic and frustrated designer Hamiltonians.}
...
{ \color{red} Recently, two Monte Carlo studies of sign problem free fermionic models with interesting ground states phases and quantum critial points have appeared. A spin liquid on the honeycomb Hubbard model between the semi-metal at weak coupling and the N\'eel state at strong coupling has been sighted~\cite{Meng10}, an accepted theory for the spin liquid state is currently unavailable~\cite{clark2011:honey,lu2011:honey,wang2010:honey}.  Most recently~\cite{berg2012:mqcp}, a sign problem free quantum action has been identified in which a bosonic order parmater condenses in the background of a Fermi surface. This opens up the exciting possibility of unbiased studies of magnetic critical points in a metal, a topic of great interest in condensed matter physics~\cite{vojta2007:rmp}.}
