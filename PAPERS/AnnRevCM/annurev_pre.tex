\documentclass[10pt,pre,aps,twocolumn,showpacs,superscriptaddress,floatfix]{revtex4}
...
integral or other mappings to an effective statistical-mechanics problem is not positive definite, hence invalidating the interpretation of the 
weights as a probability distribution for importance sampling. The approach we advocate and review here is to construct particular 
...
\begin{figure*}
\includegraphics[width=11cm, trim=120 60 50 0,clip=true,angle=-90]{fig01.eps}
%\centerline{\psfig{figure=synergy.pdf,height=4.5cm}}
\caption{(Color online) Illustration of synergies between unbiased numerical (here QMC) studies of lattice Hamiltonians, field-theories for
...
A common misconception is that interesting designer Hamiltonians should not exist---if a model is sign-problem free it must be trivial or uninteresting. 
In this article, we will review some recent counter-examples to this pessimistic view, from the area of quantum magnetism. In Fig.~\ref{rfig} 
we illustrate some of the quantum states that can be accessed with designer quantum spin Hamiltonians. Of particular interest here are states that have 
no natural classical analouges, e.g., spin liquids, which can host topological order \cite{Wen03}, and valence-bond-solids (VBSs), where crystalline order 
is formed not among the original degrees of freedom appearing in the Hamiltonian, but among emergent objects---localized singlets of two (or more) spins.
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{fig02.eps}
%\centerline{\psfig{figure=synergy.pdf,height=4.5cm}}
...
\begin{figure}
\includegraphics[width=7.0cm, clip]{fig03.eps}
...
\begin{figure}
\includegraphics[width=7.0cm, clip]{fig04.eps}
...
\begin{figure}
\includegraphics[width=6cm, clip]{fig05.eps}
...
\begin{figure}
\includegraphics[width=8cm, clip]{fig06.eps}
...
represent a common scaling function for $L\ge 48$ (approximated by a common polynomial fitted to all the data points), $f[(q-q_c)L^{1/\nu}]$, with $\nu=0.59$.}
\label{jqrhos}
\end{figure}
...
\begin{figure}
\includegraphics[width=7.5cm, clip]{fig07.eps}
...
\begin{figure}
\includegraphics[width=9cm, clip]{fig08.eps}
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{fig09.eps}
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{fig10.eps}
...
\begin{figure}
\includegraphics[width=8cm, clip]{fig11.eps}
%\centerline{\includegraphics[width=4.5in]{fig09.eps}}
...
\textcolor{red}{ model \cite{compositefieldtheory,compositeMC,Vicari}, leading to $\eta\approx  1.472(2)$.}
...
\begin{figure}
\includegraphics[width=8cm, clip]{fig12.eps}
%\centerline{\includegraphics[width=4.5in]{fig10.eps}}
