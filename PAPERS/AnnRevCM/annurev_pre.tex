...
{\color{red} In Fig.~\ref{synergy} we illustrate the synergistic role of such studies in combination with experiments and field-theory 
approaches to uncover universal physics in condensed-matter systems}.

\begin{figure*}
\includegraphics[width=11cm, trim=120 60 50 0,clip=true,angle=-90]{synergy.eps}
...
In this article, we will review some recent counter-examples to this pessimistic view, from the area of quantum magnetism. {\color{red} In Fig.~\ref{rfig} 
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{rfig.eps}
%\centerline{\psfig{figure=synergy.pdf,height=4.5cm}}
\caption{(Color online) Ground states of quantum spins on the square lattice. The left panel shows antiferromagnetic order---a state which is a direct 
generalization of classical N\'eel order, essentially adding quantum fluctuations to a classical magnetic state. The middle and right panels illustrate 
manifestly non-classical non-magnetic states, which have a natural description in terms of singlets (the ovals). In a spin liquid (middle), the singlets 
...
\begin{figure}
\includegraphics[width=7.0cm, clip]{fig01.eps}
...
\begin{figure}
\includegraphics[width=7.0cm, clip]{fig02.eps}
...
\begin{figure}
\includegraphics[width=6cm, clip]{fig03.eps}
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{fig07.eps}
...
\begin{figure}
\includegraphics[width=8.4cm, clip]{fig08.eps}
...
{\color{red} Some non-trivial solutions of sign problems are worth mentioning.
...
{ \color{red} Recently, two Monte Carlo studies of sign problem free fermionic models with interesting ground states phases and quantum critial points have appeared. A spin 
