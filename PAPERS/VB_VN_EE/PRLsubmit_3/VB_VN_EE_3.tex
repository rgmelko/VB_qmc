...
larger than that needed to converge the energy alone \cite{EPAPS}.
...
constant for large $N$ \cite{Snote}.  
%Clearly, for $S^{ \rm vN}$ the area law is indeed obeyed in the N\'eel groundstate, 
\textcolor{red}{Clearly, for $S^{ \rm vN}$  our data
suggest for $N$-leg ladders that the area law is valid in the $N \rightarrow \infty$ limit 
(i.e.~the Neel state) as well,}
leading one to conclude that the
...
For $p<2$, the bond length distribution is \textcolor{red}{unnormalizable}, and all bonds are long, so that
