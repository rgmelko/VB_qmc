...
the 3-leg and 4-leg ladder. As with the OBC 1D chain, $S^{\rm VB}
> S^{ \rm vN}$.  
...
We include ladders with L=100 sites per leg and ladders with a number of sites 
per leg (L=4N) proportional to the number of legs, N.  \label{zigzag}}} \end{figure}
