...
The properties of the VN EE are well-studied in the field of quantum information theory.
...
VN EE shows excellent agreement to $c=1$, whereas the VB EE converges
to $c<1$.
...
Hamiltonian, and reproduce the same ground state energies; Figure 1 and subsequent figures can be considered as exact comparisons between the VB and VN
EE. 
...
convergence with the central charge predicted by CFT, $c=1$, for the VN EE, while
...
({2x'})$ (inset) shows excellent convergence of the VN EE to the central
...
for the 3-leg and 4-leg ladder. As happens with the OBC 1D chain, the VB
...
%in the above section on multi-leg ladders.  
...
constant for large $N$.  Clearly, for the VN EE the area law is
indeed obeyed in the N\'eel groundstate, leading one to conclude that the
multiplicative logarithmic correction occurs in the VB EE only.  We also show data for free fermions, showing the logarithmic correction to the area law
for the VN EE in this case\cite{2dfermion}.
...
divergence to the VN EE since a gapless bosonic mode in 2D
...
In 1D, we find
that the VB EE mimics the behavior of the VN EE closely, although 
%using
%the definition of Eq.~\eqref{VBEE}, 
it is less than the VN EE for periodic
...
evaluate the adherence of the EE to the area law.  The VN EE obeys the area law in the large-leg limit, whereas the VB EE
...
Then, the state $|(12)(34)(56)(78)\rangle+|(14)(32)(58)(76)\rangle$ has vanishing VB EE since
no bonds connect $A$ to $B$, but non-vanishing VN EE.  
On the other hand, consider a 4-site chain in
the state $|(12)(34)\rangle+|(14)(32)\rangle$, and let region $A$ contain sites $1$ and $3$.  Then, the VB EE is maximal,
