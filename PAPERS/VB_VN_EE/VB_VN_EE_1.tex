...
even-leg ladders. On the contrary, rungs in odd-leg ladders can not be
fully covered by singlets, leaving one site ``un-paired'', and singlets
between distant sites are not penalized. The doubling of the period for
odd-leg ladders is due to the same dimerization effect discussed in
Ref.~\cite{Ian1}.
