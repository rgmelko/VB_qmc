...
\begin{abstract}
We present a direct comparison of von Neumann entanglement entropy and the recently proposed valence bond entanglement entropy on spin-1/2 Heisenberg systems using results from density-matrix renormalization group measurements and quantum Monte Carlo simulations in the valence bond basis.  For 1-dimensional spin chains we find both cases where the valence bond entropy is above and cases where it is below the von Neumann entropy, indicating that valence bond entropy can not be used as a bound for von Neumann entropy.  Using a ladder geometry we are able to reproduce the multiplicative logarithmic corrections previously found in the area law for valence bond entropy, however we find that von Neumann entropy follows the area law without correction.
...
discussions.  
This work was made possible by the computing facilities of SHARCNET.
 Support for this work was provided by NSERC of Canada.
