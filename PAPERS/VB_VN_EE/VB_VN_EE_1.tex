...
\caption{(color online) The VB and VN entanglement entropies (taken such that {\it system} $A$ includes $2N^2$ sites) normalized by N, the number of legs.  All ladders have 100 sites per leg.
\label{S(x)/x}}}
\end{figure}
