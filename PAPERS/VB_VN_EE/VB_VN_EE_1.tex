...
equal to $2\log(2)$, while the VN EE is smaller.  The second state we have described is in fact the Neel state with no
quantum fluctuations: it is the equal amplitude superposition of all configurations of bonds going from one sublattice to the other.
Thus, it is not surprising that states with Neel order show VB EE larger than VN EE.
