...
%Within this picture, one expects
%higher EE values when the boundary between A and B cuts a rung, than when
%cuts only legs. Within the same rung, sites at the ends will tend to form
%singlets with its only neighbor in the rung and EE will be larger for
%$(x\div N) \equiv 1 \mod{2}$, than for $(x\div N) \equiv 0 \mod{2}$,
%explaining the period with $N$ for the even-leg ladders. 
On the contrary,
