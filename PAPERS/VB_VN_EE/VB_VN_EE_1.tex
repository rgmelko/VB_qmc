...
to contain contain $2N^2$ sites ...{\bf Matt: some
argument involving the sum over quasi-1D modes? }.
...
multiplicative logarithmic correction occurs in the VB EE only.  In the next section, we explain this 
