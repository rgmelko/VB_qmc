...
The expectation value of a sum of these operators for nearest neighbour pairs $i,j$ (i.e. Equation \ref{Heis}) can be sampled over the simulation in order to obtain an estimate for the energy.
