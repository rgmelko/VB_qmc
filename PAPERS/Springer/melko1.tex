...
\end{enumerate}
Throughout this update, the spin state should be propagated from $\langle \alpha_{\ell} |$ to $| \alpha_r \rangle$ in a way consistent with the off-diagonal operators.  Otherwise, one would sample a normalization weight equal to zero, Equation \ref{Zproj2b}.
