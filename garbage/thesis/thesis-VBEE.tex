...
%======================================================================
\comment{Cite *our* paper somewhere in here.}
...
Figure \ref{1dPBC} shows the \vb measurements for a periodic spin chain of length $L=100$ sites, plotted alongside \vn data.  \vb seems to fit well to the \comment{CFT result}, though it is lower than \vN.
...
\change{
The \vb measurement does not properly normalize the state in Fig. \ref{example1}.
Thing about how this is the N\'eel state...}
