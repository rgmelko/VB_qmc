...
C &= \frac{1}{\sqrt{\bra{\psi}\psi\rangle}} = \frac{1}{\sqrt{4+4+1+1+1+1}} = \frac{1}{\sqrt{12}}
 ...
 \begin{eqnarray} \nonumber
 \ket{\up\up} \rightarrow \ket{a} \hspace{1cm} \ket{\up\dw} \rightarrow \ket{b}  \hspace{1cm} 
 \ket{\dw\up} \rightarrow \ket{c}  \hspace{1cm} \ket{\dw\dw} \rightarrow \ket{d} \nonumber
 \end{eqnarray}
