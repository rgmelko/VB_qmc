...
Linear regression fits of the \vb and \vn data for several system sizes (Figure~\ref{c1}) shows $c^{\rm vN}$ approaching 1 as the system size increases, however $c^{\rm VB}$ seems to approach a lower value.
...
Figure \ref{c2} shows the linear regression fits of the lower branches of OBC data for several different system sizes to $\VN_{\text{OBC}}$ from Equation \eqref{cft1d}.
