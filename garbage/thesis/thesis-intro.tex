...
\comment{Probably mention all the Renyi entropies somewhere in this chapter, and perhaps show that the von Neumann is $S_1$?}

\comment{Use paper intros for motivation.}
