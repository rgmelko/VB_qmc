...
However, returning to my previous point, if the initial state was already mixed instead of pure, the state would already have some entropy not due to tracing out region B; added to our measurement would be the initially present classical uncertainty in the state.
