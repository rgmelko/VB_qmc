...
The scaling of entanglement in condensed matter systems has potential ramifications for the rapidly advancing field of computational quantum many-body theory, where it is known that states obeying an {\it area law} \cite{Shredder} scaling  (entanglement scales as the size of the boundary between regions A and B) scaling can be accurately represented with matrix product states \cite{MPS_DMRG}, but faster than area law scaling presents difficulties.
...
The scaling of \vn is well understood in 1D systems \cite{ALreview} were, away from special critical points, entanglement between two regions scales as the size of the boundary between those regions.
