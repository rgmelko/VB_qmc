...
the standard deﬁnition of entanglement entropy: the von Neumann entanglement entropy, measure using density matrix renormalization group simulations. 
...
using double projector valence bond quantum Monte Carlo, and show results for the second Renyi entropy. 
We ﬁnd the results converge to the exact results for one dimensional Heisenberg spin-1/2 
