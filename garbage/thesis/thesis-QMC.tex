...
We can choose the valence bond covering containing only bonds going from sublattice A
...
{\color{red}
- next look at the number of VB states -- check\\
- then the restricted set\\
