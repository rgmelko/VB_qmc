...
\begin{enumerate}
\item{\fbox{Choose or generate an initial valence bond state $\ket{V}$.}}
\item{\fbox{Generate a list of m random bond operators $P_{r_1}$.}}
\item{\fbox{Apply the list of bond operators  $P_{r_i}$ to $\ket{V}$ to get $\ket{V(r_i)}$.}}
