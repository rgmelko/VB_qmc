...
\begin{enumerate}
\item \fbox{\parbox{415pt}{Choose or generate an initial valence bond state $\ket{V}$.}}
\item \fbox{\parbox{415pt}{Generate a list of m random bond operators $P_{\text{old}}$.}}
\item \fbox{\parbox{415pt}{Apply the list of bond operators to the initial state.  
		\begin{equation}
		P_{\text{old}}\ket{V}=W_{\text{old}}\ket{V_{\text{old}}} \nonumber
		\end{equation}
		}}
\item \fbox{\parbox{415pt}{Randomly change a predetermined number, 
		$q$, of the bond operators 
		in $P_{\text{old}}$ and relabel it as $P_{\text{new}}$.}}
\item \fbox{\parbox{415pt}{Apply the new list of bond operators to the original initial state. 
