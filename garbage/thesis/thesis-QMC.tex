...
To simulate applying the Hamiltonian to a state $m$ times we apply a list of  $m$ bond operators to
a trial state $\ket{V}$:
\begin{equation}
\end{equation}
