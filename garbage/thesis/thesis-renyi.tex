...
The data in Fig. \ref{2Darea} appears consistent with the area law $S_2/\ell \sim \text{const.}$ for $\ell \ll L$, in particular we do not see a multiplicative log correction as was present in \vB \cite{Alet, Chh}. 
...
\begin{figure} {
	\includegraphics[width=5in]{./figures/made/awesomeplot/marea.eps} 
	\caption[fds]{ 
	fds
		\label{2Dbetter1}
	}
