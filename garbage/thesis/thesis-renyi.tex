...
\section{1D Results}
%----------------------------------------------------------------------------------------------------------
We begin with $S_2$ results for a 1D OBC chain of length L=100, illustrated in Figure \ref{1Dfig}.
The plot shows results from DMRG, and results from VB QMC using the expectation value of the \swa operator.
...
\begin{figure} {
	...
	\label{swapfig}
		\change{	The Renyi entropy $S_2$ as a function of site index $i \in A$, for a 100-site Heisenberg chain with open boundaries, 
