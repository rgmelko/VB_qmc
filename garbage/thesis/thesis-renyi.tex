...
A double projector VB QMC algorithm is used, and we also show results measured using the loop algorithm.
...
\begin{figure} {
	...
	\caption[$S_2$ in an $8 \times 8$ and a $12 \times 12$ system for different values of $r$]{ 
...
\begin{figure} {
	\vspace{-1cm}
	\hspace{1cm}
	\includegraphics[width=5in]{./figures/made/awesomeplot/marea2.eps} 
