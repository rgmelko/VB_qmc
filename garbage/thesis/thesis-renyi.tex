...
\change{Has been used before in lots of stuff (more refs)\cite{Cardy, Callan, Fradkin}
But this is its first use with QMC.  mention $\kappa$?}

We can compute ${\rm Tr} \rho^n_{\rm A}$ using n, non-interacting copies of the system.
...
We have presented a method which can be used to measure the Renyi entropies \comment{eqref} for $n>1$, with quantum Monte Carlo simulations in the valence bond basis, employing the "replica trick".
