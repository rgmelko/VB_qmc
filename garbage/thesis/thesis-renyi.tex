...
However, when we begin to measure larger system sizes and move to 2D the deficiencies in measuring the bare \swa operator will become even more apparent; it is necessary to improve upon this measurement technique, which we have done using a ``ratio trick''.
