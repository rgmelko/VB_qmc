...
In contrast, swapping only one site ($x=1$) will always decrease the number of loops by 1, so $S(1)=\ln(2)$ always.
...
Measurements taken using the loop algorithm are added into Figure \ref{loopfig}
