...
We then present a method to measure higher orders of the generalized Renyi entropies 
using valence bond quantum monte carlo, and show results for the second renyi entropy. 
