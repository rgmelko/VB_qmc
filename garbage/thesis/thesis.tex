...
\chapter{Conclusions}
%======================================================================
In this thesis we examined methods for measuring entanglement entropy in spin-1/2 
...
We then presented a method to measure the generalized Renyi entropies (excluding $S_1$)
using double projector valence bond quantum Monte Carlo, and showed results for the second Renyi entropy. 
We find the results converge to the exact results (measured using DMRG) for one dimensional Heisenberg spin-1/2 
chains, and see that the scaling of the second Renyi entropy follows an area law in the two 
dimensional Heisenberg ground state.
