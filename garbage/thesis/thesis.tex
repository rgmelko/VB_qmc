...
\newcommand{\vn}{$S^{\text{vN}}$ }
\newcommand{\vN}{$S^{\text{vN}}$}
\newcommand{\VN}{S^{\text{vN}} }
\newcommand{\vb}{$S^{\text{VB}}$ }
\newcommand{\vB}{$S^{\text{VB}}$}
\newcommand{\VB}{S^{\text{VB}} }

\newcommand{\re}{$S_2$ }
\newcommand{\sw}{{\it Swap} }
\newcommand{\sW}{{\it Swap}}
\newcommand{\swa}{${\it Swap}_{\rm A}$ }
\newcommand{\swA}{${\it Swap}_{\rm A}$}
\newcommand{\SWA}{{\it Swap}_{\rm A}}
...
%_____END OF HEADER STUFF______
...
\ifthenelse{\boolean{ElectronicVersion}}{
	...
	pdftitle=Ann\ Thesis, 
	pdfauthor=Ann\ Berlinsky\ Kallin	
	]{hyperref}}{}
...
%======================================================================
\input{thesis-QMC.tex}
%======================================================================
%======================================================================
\input{thesis-VBEE.tex}
%======================================================================
%======================================================================
\input{thesis-renyi.tex}
%======================================================================
...
the standard deﬁnition of entanglement entropy: the von Neumann entanglement entropy, measured using density matrix renormalization group simulations. 
...
Though the valence bond entanglement entropy has the advantage of its simplicity of measurement, presence of the multiplicative correction to the area law scaling will most likely compromise  its usefulness in the measurement of universal quantities.


We then presented a method to measure the generalized Renyi entanglement entropies (excluding $S_1$) through the expectation value of a $Swap$ operator acting on two non-interacting copies of a system.
Measurements of the second Renyi entropy were done using double projector valence bond quantum Monte Carlo and compared to results obtained using density matrix renormalization group simulations.  
...
\comment{Now Roger says I'm supposed to talk about how measuring EE with revolutionize physics. ``Razzle dazzle" he says.

I guess we could measure some of the subleading corrections to the area law and get some of those universal quantities if we can look at a system with topological order.
Maybe I can talk more about the PRB (finite T measurement of EE), though it's a little ridiculous to measure EE at finite T because then you're starting off with a mixed state instead of a pure state, but I guess we actually measured mutual information, instead of entropy.

Oh, and I'm supposed to stress how the neel state is the *first* interacting 2D model shown to obey the area law.  *first*
}
