...
We have developed the first method that can be used to measure entanglement in condensed matter systems with a scalable simulation technique.
There are countless models to be studied and an untold number of questions that can be explored with this new measurement.
