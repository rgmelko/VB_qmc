...
There is a technique called {\it multicanonical sampling} which allows the simulation to reach every point in the space of values of $\langle Swap \rangle$ with equal probability with the help of a weighting function.
...
We have developed the first method used to measure entanglement in condensed matter systems with a scalable simulation method.
There are countless models to be studied and an untold number of questions can be answered  only now that we are able to measure entropy in these systems.
